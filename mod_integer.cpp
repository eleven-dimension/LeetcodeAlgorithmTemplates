...
class ModInteger final {
 ...
 public:
  ...
  template <class U>
  constexpr ModInteger(ModInteger<Mod, U> mod_value)
      : ModInteger(mod_value.val()) {}
...
#pragma GCC diagnostic pop
    ...
    std::cout << "No overflow and more simple: " << ModBig(1000000006) * 3
              << std::endl;
  }

  {
    using ModBig = ModInteger<1000000007>;
    std::cout << "(2 ^ 10000) % (10 ^ 9 + 7) is " << (ModBig(2) ^ 10000)
              << std::endl;
  }
}
